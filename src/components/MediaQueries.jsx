        ...
        <div className="main-page_background-image">
            ...
            <section className="main-page_section">
                <div className="main-page_section-content">
                    ...
                    <div className="main-page_section_about-image">
            ...
            <section className="main-page_mid-section">
                <div className="main-page_image-container">
                    <div className="main-page_group-image">
                        <img src={officeSpace1} alt="picture of office space" />
                        <p>A quiet and minimal ambience</p>
                    </div>
                    <div className="main-page_group-image">
                        <img id="shorten-image" src={officeSpace2} alt="picture of office space" />
                        <p>A quiet and minimal ambience</p>
                    </div>
                    <div className="main-page_group-image">
                        <img src={officeSpace3} alt="picture of office space" />
                        <p>A quiet and minimal ambience</p>
                    </div>
                    <div className="main-page_group-image">
                        <img src={officeSpace4} alt="picture of office space" />
                        <p>A quiet and minimal ambience</p>
                    </div>
                </div>
            </section>
